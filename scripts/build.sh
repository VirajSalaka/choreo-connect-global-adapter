...
GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go build -v -o target/global-adapter-linux github.com/wso2-enterprise/choreo-connect-global-adapter/cmd/global_adapter
if [ $? -ne 0 ]; then 
